...
class TestCompoundWeatherPayment:
    ...
    async def test_weather_takes_priority_over_payment(self):
        ...
        mock_response = LLMResponse(
            ...
            model="test", input_tokens=200, output_tokens=30, latency_ms=250,
        )
        ...
        with patch("app.agents.graphs.orchestrator.llm_router") as mock:
            ...
            state: OrchestratorState = {
                ...
                "recent_events": [
                    {"event_type": "payment_overdue", "description": "$4250 overdue 5 days", "agent_name": "payment"},
                ],
        ...
        with patch("app.agents.graphs.orchestrator.llm_router") as mock:
            ...
            state: OrchestratorState = {
                ...
                "trigger_event": {
                    ...
                    "data": {"milestone": "Shingles Installed", "issues": ["misalignment", "exposed nails"]},
                },
                ...
                "recent_events": [
                    {"event_type": "price_update_flagged", "description": "Shingles +15%", "agent_name": "supplier_webhook"},
                    {"event_type": "customer_message", "description": "Why is this taking so long?", "agent_name": "engagement"},
                ],
                "next_agent": "", "agent_input": {},
                "decision_reasoning": "", "confidence": 0.0,
                "actions_taken": [], "events_emitted": [],
...
class TestPaymentEdgeCases:
    ...
    async def test_invoice_with_zero_amount(self):
        ...
        state: PaymentState = {
            "company_id": "co-1", "project_id": "p-1",
            "trigger": {}, "project_status": "in_progress",
            "contract_amount": 10000, "amount_paid": 10000,
    ...
    async def test_reminder_with_no_phone(self):
        ...
        state: PaymentState = {
            "company_id": "co-1", "project_id": "p-1",
            "trigger": {}, "project_status": "in_progress",
            "contract_amount": 10000, "amount_paid": 0,
            "amount_due": 10000, "customer_phone": "",
            "customer_email": "", "from_phone": "",
            "property_address": "123 Oak St",
            "payment_schedule": [],
    ...
    async def test_escalate_reminder_at_30_days(self):
        ...
        state: PaymentState = {
            "company_id": "co-1", "project_id": "p-1",
            "trigger": {}, "project_status": "invoiced",
            "contract_amount": 10000, "amount_paid": 0,
            "amount_due": 10000, "customer_phone": "+15551234567",
            "customer_email": "", "from_phone": "+15559999999",
            "property_address": "123 Oak St",
            "payment_schedule": [],
            "current_milestone_payment": {"type": "reminder", "amount": 10000},
