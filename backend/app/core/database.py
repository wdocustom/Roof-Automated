...
async def get_tenant_session(company_id: str) -> AsyncGenerator[AsyncSession]:
    ...
    async with async_session_factory() as session:
        ...
        # Use set_config() instead of SET LOCAL because asyncpg's prepared-
        # statement protocol doesn't support parameterized SET commands
        # through Neon's connection pooler. set_config with is_local=true
        # scopes the value to the current transaction.
